...
public class GoogleAuthenticationService implements IAuthenticationService {
    ...
    public Credential getCredentials(NetHttpTransport httpTransport) throws IOException {
        InputStream input = GoogleAuthenticationService.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (input == null) {
